        ...
        <aside className="w-80 bg-gray w-fulll hidden sm:block">
          <div className="flex flex-col justify-between h-full p-4 bg-gray-800">
            <div className="text-sm">
              <div className="bg-gray-900 text-white p-2 rounded mt-2 cursor-pointer hover:bg-gray-700 hover:text-blue-300"><Link to="post">Post</Link></div>
              <div className="bg-gray-900 text-white p-2 rounded mt-2 cursor-pointer hover:bg-gray-700 hover:text-blue-300"><Link to="product">Product</Link></div>
              {/* <div className="bg-gray-900 text-white p-2 rounded mt-2 cursor-pointer hover:bg-gray-700 hover:text-blue-300"><Link to="category">Category</Link></div>
              <div className="bg-gray-900 text-white p-2 rounded mt-2 cursor-pointer hover:bg-gray-700 hover:text-blue-300"><Link to="user">User</Link></div> */}
            </div>
