    ...
    <footer className="footer-main bg-black px-[10%] pt-[80px]">
      <div className="row-flex flex justify-between pb-10">
        ...
        <div className="col store w-[230px]">
          ...
          <ul className="navlink">
            <li className='h-5'><a href="" className='text-white text-xs text-opacity-20 hover:text-opacity-60'>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-[0px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                <path stroke-linecap="round" stroke-linejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>Trịnh Văn
              Bô - Nam Từ Liêm - Hà Nội</a></li>
            <li className='h-5'><a href="" className='text-white text-xs text-opacity-20 hover:text-opacity-60'>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-[0px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
