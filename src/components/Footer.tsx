      ...
      <div className="row-flex flex justify-between pb-10">
        <div className="col w-[300px]">
          <Link to="#">
            <img
              className="h-[100px]"
              src="https://is1-ssl.mzstatic.com/image/thumb/Purple126/v4/99/e9/b9/99e9b974-b824-15c3-1eea-59669fa296d6/AppIconSSPV6-0-0-1x_U007emarketing-0-0-0-7-0-0-sRGB-0-0-0-GLES2_U002c0-512MB-85-220-0-0.png/1200x630wa.png"
              alt=""
            />
          </Link>
          <p>
          ...
          <div className="social-block flex">
            <a href="#">
              <svg
                className="w-[35px] h-[35px] mx-2 my-2"
            ...
            <a href="#">
              ...
              >
                ...
                <path
                  fill="#CC202D"
                  d="M431.4 80.6c96.9 96.9 96.9 254 0 350.8-96.9 96.9-254 96.9-350.8 0L431.4 80.6z"
                />
                <path
                  fill="#BA202E"
                  d="M499.1 305.7L376.3 182.9l-144.8 16.5L143.9 335l163.7 163.7c96.2-20.4 171.9-96.5 191.5-193z"
                />
                <path
                  fill="#FFF"
                  fillRule="evenodd"
                  d="M385.8 208.1c0-20.8-16.8-37.6-37.6-37.6H171.6c-20.8 0-37.6 16.9-37.6 37.6v101c0 20.8 16.8 37.7 37.6 37.7h176.5c20.8 0 37.6-16.9 37.6-37.7v-101zm-151.1 93.1v-94.8l71.9 47.4-71.9 47.4z"
                  clipRule="evenodd"
                />
              </svg>
            </a>
        ...
        <div className="col infor w-[230px]">
          <h5 className="title-footer font-bold text-base text-white">
            Information
          </h5>
          <ul className="navlink">
            <li className="py-2">
              <Link
                to="#"
                className="text-white text-xs text-opacity-20 hover:text-opacity-60"
              >
                About Us
              </Link>
            </li>
      ...
      <div className="bottom-footer flex justify-between h-10">
        <div className="contact-footer">
          <p className="text-white text-xs leading-8">
            Powered By <a href="#">OpenCart</a> Artcraft - Arts & Craft Store ©
            2022
          </p>
        </div>
        <div className="payment-footer flex py-2">
          <a href="#" className="mx-2">
            <img
              src="https://capricathemes.com/opencart/OPC02/OPC020033/image/catalog/visa.png"
              alt=""
            />
          </a>
          <a href="#" className="mx-2">
            <img
              src="https://capricathemes.com/opencart/OPC02/OPC020033/image/catalog/discover.png"
              alt=""
            />
          </a>
          <a href="#" className="mx-2">
            <img
              src="https://capricathemes.com/opencart/OPC02/OPC020033/image/catalog/american_express.png"
              alt=""
            />
          </a>
          <a href="#" className="mx-2">
            <img
              src="https://capricathemes.com/opencart/OPC02/OPC020033/image/catalog/google_wallet.png"
              alt=""
            />
          </a>
          <a href="#" className="mx-2">
            <img
              src="https://capricathemes.com/opencart/OPC02/OPC020033/image/catalog/paypal.png"
              alt=""
            />
          </a>
        </div>
