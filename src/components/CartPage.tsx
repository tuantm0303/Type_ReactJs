...
function CartPage() {
  return (
    <>
      <div
        className="w-full h-full top-0 overflow-y-auto overflow-x-hidden sticky-0"
        id="chec-div"
      >
        <div
          className="w-full flex justify-center z-10 right-0 h-full overflow-x-hidden transform translate-x-0 transition ease-in-out duration-700"
          id="checkout"
        >
          <div
            className="lg:w-1/2 md:w-8/12 w-full lg:px-8 lg:py-14 md:px-6 px-4 md:py-8 py-4 bg-white overflow-y-hidden overflow-x-hidden h-auto"
            id="scroll"
          >
            ...
            <p className="lg:text-4xl text-3xl font-black leading-10 pt-3">
              Cart
            </p>
          ...
          <div className="lg:w-96 md:w-8/12 w-full pt-10 justify-between overflow-y-hidden overflow-x-hidden h-auto">
            ...
            <div>
              ...
              <button className="text-base leading-none w-full py-5 bg-gray-800 border-gray-800 border focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 hover:bg-gray-700">
                Checkout
              </button>
            </div>
          </div>
